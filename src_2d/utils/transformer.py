    ...
    for file in subjects_files:
        ...
        if encodings_file_path:
            ...
            try:
                ...
                print("Cannot find Encoding nii for ", file)
                mia_subjects += 1
                valid_subject = False
                break
...
def prepare_batch(
    ...
    if original_nii_path is not None:
        ...
        return (x_input, x_encoding, conditioned, token_mask_input, x_original_input), x_target
    else:
        return (x_input, x_encoding, conditioned, token_mask_input), [x_target, token_mask_loss]
