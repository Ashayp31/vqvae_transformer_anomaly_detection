...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    --training_subjects='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne256_dim128_original/baseline_vqvae/testing_codes_pet_challenge/' \
    --validation_subjects='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne256_dim128_original/baseline_vqvae/testing_codes_pet_challenge/' \
    --encoding_conditioning_path='/nfs/home/apatel/Data/combined_multicrop_vis/testing/pet_challenge_testing_conditioning_groupspace.csv' \
