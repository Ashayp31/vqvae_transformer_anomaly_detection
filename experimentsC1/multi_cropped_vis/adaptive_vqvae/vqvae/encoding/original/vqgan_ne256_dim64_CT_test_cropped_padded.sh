...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/run_vqvae.py run \
    --training_subjects='/nfs/home/apatel/Data/combined_multicrop_vis/testing_varied/Cropped_Padded_CT' \
    --validation_subjects='/nfs/home/apatel/Data/combined_multicrop_vis/testing_varied/Cropped_Padded_CT' \
    --project_directory='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/' \
    --experiment_name='vqgan_ne_256_dim64_CT_original' \
    --mode='extracting' \
    --device=0 \
    --amp=True \
    --deterministic=False \
