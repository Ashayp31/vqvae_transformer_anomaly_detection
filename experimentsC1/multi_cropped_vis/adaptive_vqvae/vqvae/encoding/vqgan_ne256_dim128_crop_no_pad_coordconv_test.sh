...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/run_vqvae.py run \
    --training_subjects='/nfs/home/apatel/Data/combined_multicrop_vis/testing/PET' \
    --validation_subjects='/nfs/home/apatel/Data/combined_multicrop_vis/testing/PET' \
    --project_directory='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/' \
    --experiment_name='vqgan_ne256_dim128_crop_no_pad_coordconv' \
    --cropping_file='/nfs/home/apatel/Data/combined_multicrop_vis/testing/encoding_spatial_conditioning.csv' \
    --mode='extracting' \
    --device=0 \
    --amp=True \
    --deterministic=False \
