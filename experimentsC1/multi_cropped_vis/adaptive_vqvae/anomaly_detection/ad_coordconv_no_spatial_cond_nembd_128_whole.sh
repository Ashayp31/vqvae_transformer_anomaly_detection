...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    ...
    --transformer_network_checkpoint='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne256_dim128_crop_no_pad_coordconv/performer_no_conditioning_nemb_128/checkpoints/checkpoint_epoch=80.pt' \
    ...
    --prefetch_factor=8 \
    --starting_epoch=0 \
    --network='performer_no_conditioning_nemb_128' \
    --vocab_size_enc=256 \
    --vocab_size=256 \
    --n_embd=128 \
    --n_layers=14 \
