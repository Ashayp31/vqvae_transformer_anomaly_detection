...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    --training_subjects='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne256_dim128_original/baseline_vqvae/generate_samples/' \
    --validation_subjects='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne256_dim128_original/baseline_vqvae/generate_samples/' \
    --encoding_conditioning_path='/nfs/home/apatel/Data/combined_multicrop_vis/testing_original_conditioning.csv' \
