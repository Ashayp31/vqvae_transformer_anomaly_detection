...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    --training_subjects='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/generate_samples_direc/' \
    --validation_subjects='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/generate_samples_direc/' \
