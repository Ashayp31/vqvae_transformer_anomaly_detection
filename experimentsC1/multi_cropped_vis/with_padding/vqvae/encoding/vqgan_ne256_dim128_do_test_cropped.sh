...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/run_vqvae.py run \
    --training_subjects='/nfs/home/apatel/Data/combined_datasets/multi_crop_vis/PET_testing_cropped/' \
    --validation_subjects='/nfs/home/apatel/Data/combined_datasets/multi_crop_vis/PET_testing_cropped/' \
