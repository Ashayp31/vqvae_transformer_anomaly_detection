...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/run_vqvae.py run \
    --training_subjects='/nfs/home/apatel/Data/combined_datasets/multi_crop_vis/CT_testing_cropped/' \
    --validation_subjects='/nfs/home/apatel/Data/combined_datasets/multi_crop_vis/CT_testing_cropped/' \
    --project_directory='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/' \
    --experiment_name='vqgan_suv_15_jp_ne256_dim64_CT' \
    --mode='extracting' \
    --device=0 \
    --amp=True \
    --deterministic=False \
