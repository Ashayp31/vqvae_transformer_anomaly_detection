...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    ...
    --spatial_encoding_path='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis_partial_body_training/CT_Generative_ne256_dim128/spatial_encoding_locations_10.csv' \
    ...
    --transformer_network_checkpoint='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis_partial_body_training/CT_Generative_ne256_dim128/performer_ct_spatial_10/checkpoints/checkpoint_44.pt' \
    ...
    --prefetch_factor=8 \
    --starting_epoch=0 \
    --network='performer_ct_spatial_10' \
    --vocab_size_enc=256 \
    --vocab_size=256 \
    --n_embd=512 \
    --n_layers=16 \
    ...
    --spatial_conditioning_buckets=1000 \
    --max_seq_len=14742 \
