...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    ...
    --transformer_network_checkpoint='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis_partial_body_training/vqgan_ne256_dim128_PET/performer_pet_spatial/checkpoints/checkpoint_epoch=80.pt' \
