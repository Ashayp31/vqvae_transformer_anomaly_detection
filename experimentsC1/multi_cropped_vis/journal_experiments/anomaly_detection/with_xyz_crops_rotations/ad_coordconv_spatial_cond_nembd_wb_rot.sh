...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/anomaly_detection_conditional.py run \
    ...
    --spatial_encoding_path='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne512_dim256_rotations_xyz_crops/testing_rotated_spatial_encoding_locations.csv' \
    --cropping_file='/nfs/home/apatel/CT_PET_FDG/multi_crop_vis/vqgan_ne512_dim256_rotations_xyz_crops/testing_rotated_spatial_encoding_locations.csv' \
