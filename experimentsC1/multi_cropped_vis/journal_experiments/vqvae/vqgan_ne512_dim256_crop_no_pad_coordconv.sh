...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/vqvae-main/run_vqvae.py run \
    --training_subjects="('/nfs/home/apatel/Data/combined_datasets/PET_FDG/training', '/nfs/home/apatel/Data/PET_Challenge_niftis/PET_original_voxels_SUV_15')" \
    ...
    --experiment_name='vqgan_ne512_dim256_rotations_xyz_crops_2_nonadv' \
    --mode='training' \
    --device=0 \
    --amp=True \
    --deterministic=False \
